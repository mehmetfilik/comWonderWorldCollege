Feature: Admin Payment Management
  ...
  Scenario: Verify the functionality of Fees Master in Student Information section
    ...
    And User selects "Certificate Fee" from the "Fees Group" dropdown menu in the "Add Fees Master" window
    And User selects "QA-SDET Certificate" as the "Fees Type" in the "Add Fees Master" window
    And User enters "250.00" in the "Amount" field in the "Add Fees Master" window
    ...
    And User selects "Salisforce Certificate" as the "Fees Type" in the edit window
    ...
    And User clicks the delete icon for the last item in the "Fees Master List" section
